...
public class QueryController {
    ...
    public Flux<ReadingStatistic> queryStatistics(@Valid @RequestBody Query query) {
        return this.readingService.queryStatistics(query);
    }

    @GetMapping(path = "machine-id")
    @ResponseStatus(value = OK)
    public Mono<List<String>> distinctMachineIds() {
        return this.readingService.distinctMachineIds().collectList();
    }
}
